...
DATASET_TRAIN_PATH_SPAM = PATH_BASE + "//datasets/spam.csv"
DATASET_TRAIN_PATH = PATH_BASE + "//datasets/dataset_train.csv"
DATASET_TRAIN_MUESTRA_PATH = PATH_BASE + "//datasets/dataset_train_muestra.csv"
...
FILE_ID_DRIVE = '1n3nBaUf2HNdYrwA-w8td6E74enWta5VO'
